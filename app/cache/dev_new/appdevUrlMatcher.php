...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // listreat_api_item_delete
        if (0 === strpos($pathinfo, '/api/items/delete') && preg_match('#^/api/items/delete/(?P<item>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Listreat\\ApiBundle\\Controller\\ItemController::deleteAction',)), array('_route' => 'listreat_api_item_delete'));
        }
