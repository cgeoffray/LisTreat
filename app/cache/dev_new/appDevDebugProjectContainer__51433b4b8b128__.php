...
/**
 * appDevDebugProjectContainer__51433b4b8b128__
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class appDevDebugProjectContainer__51433b4b8b128__ extends Container
{
    /**
     * Constructor.
     */
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/annotations', true);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager51433b4ec5409_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager51433b4ec5409_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/jms_diextra/doctrine/EntityManager_51433b4ec5409.php';
        ...
        $h->setProxyDir('/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager51433b4ec5409_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/jms_diextra/metadata'));
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/assetic/routing.yml', array('cache_dir' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginService()
    {
        ...
        return $this->services['security.firewall.map.context.login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('fos_user.user_provider.username')), 'login', $b, $this->get('event_dispatcher')), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '51433b4e171ff', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'login', NULL, NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $b), 'main', $c, $d), 2 => $i, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '51433b4e171ff', $c), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/login', false), NULL, NULL, $c));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/sessions');
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.user', 1 => 'sonata.admin.shop', 2 => 'sonata.admin.item'));
        $instance->setAdminGroups(array('User' => array('label' => 'User', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.user')), 'Shop' => array('label' => 'Shop', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.shop')), 'Item' => array('label' => 'Item', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.item'))));
        $instance->setAdminClasses(array('Listreat\\UserBundle\\Entity\\User' => 'sonata.admin.user', 'Listreat\\MainBundle\\Entity\\Shop' => 'sonata.admin.shop', 'Listreat\\MainBundle\\Entity\\Item' => 'sonata.admin.item'));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.user', 1 => 'sonata.admin.shop', 2 => 'sonata.admin.item'), $this);
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/twig', 'charset' => 'UTF-8', 'paths' => array()));
     ...
     *
     * @return EntityManager51433b4ec5409_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new',
            ...
            'kernel.container_class' => 'appDevDebugProjectContainer__51433b4b8b128__',
            ...
            'debug.container.dump' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/appDevDebugProjectContainer__51433b4b8b128__.xml',
            ...
            'session.save_path' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/profiler',
            ...
            'router.resource' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/jms_diextra/doctrine/EntityManager_51433b4ec5409.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager51433b4ec5409_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Applications/MAMP/htdocs/LTCoaching/app/cache/dev_new/jms_security',
