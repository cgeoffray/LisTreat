...
class __TwigTemplate_92e6d0b02bd0adaea3bd4a6edc589c68 extends Twig_Template
{
    ...
    {
        // line 6
        if (($this->getAttribute($this->getContext($context, "user"), "id") == $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "user"), "id"))) {
            // line 7
            echo "<a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("profil_update", array("id" => $this->getAttribute($this->getContext($context, "user"), "id"))), "html", null, true);
